...
public record DataAuthor(
        @JsonAlias("name") String name,                              // Nombre del autor
        @JsonAlias("birth_year") Integer birthYear,  // Año de nacimiento (puede ser negativo para autores antiguos)
        @JsonAlias("death_year") Integer deathYear   // Año de fallecimiento (puede ser null si el autor está vivo)
) {}
